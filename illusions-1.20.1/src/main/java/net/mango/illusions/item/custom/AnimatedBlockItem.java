...
import net.mango.illusions.blocks.entity.client.AnimatedBlockItemRenderer;
...
public class AnimatedBlockItem extends BlockItem implements GeoItem {
    ...
    private <T extends GeoAnimatable> PlayState predicate(AnimationState<T> tAnimationState) {
        tAnimationState.getController().setAnimation(RawAnimation.begin().then("Unactivated", Animation.LoopType.LOOP));
